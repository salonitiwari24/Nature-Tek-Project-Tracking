...
console.log('--- Nature Tek Solar PMS: Pure JavaScript Data Auditing Tool ---');
...
// Helper to extract all matching occurrences of a regex pattern in a file
...
// 1. Extract IDs from registry files
...
while ((match = taskBlockRegex.exec(taskContent)) !== null) {
  ...
  // Extract relationships inside this block
...
// 3. Audit Milestones relationships
...
while ((match = milestoneBlockRegex.exec(milestoneContent)) !== null) {
  ...
  // Auditing dependency chaining references
...
// 4. Audit Documents relationships
